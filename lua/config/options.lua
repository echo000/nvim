...
--TEMP MOVED PATH_FINDER TO nvim.bak as it looks like iabdelkareem/csharp.nvim is better
...
--         {
--             base_path = "C:/Dev/Vex",
--             dotnet_proj_file = "C:/Dev/Vex/src/Vex.sln",
--             dotnet_dll_path = "C:/Dev/Vex/src/Vex/bin/x64/Debug/Vex.dll",
--             dotnet_debug_cwd = "C:/Dev/Vex/src/Vex", -- Useful for large, multi-project debugging
--         },
--     },
-- })
